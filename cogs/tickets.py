...
class Tickets(commands.Cog):
    ...
    async def set(self, ctx):
        # Fallback if set is not already defined in another cog or grouped properly
        # Note: Since welcome.py also has @commands.group set, this might conflict depending on extension load order.
        # Let's handle this smoothly. In a real scenario, you'd have a core settings cog or merge them.
        pass
